...
import { setUpcomingMovies } from '../actions/index'
...
describe('upcomingMoviesReducer', () => {
  ...
  test('should return a state with new upcoming movies', () => {
    const expected = [
      {
    ...
    const result = upcomingMoviesReducer([], setUpcomingMovies(expected))
